...
# 21 "mcc_generated_files/../Sensors/Dummy.h"
...
void ADCC_ISR(void)
{
        ...
        waarden[x] = ADCC_GetConversionResult();
        x++;

        if(waarden[x-1]> maxValue){
            maxValue = waarden[x-1];
        }
# 335 "mcc_generated_files/adcc.c"
        if(x > 9){
            ADCC_StopConversion();
            for(int i = 0; i< 10 ; i++){
                waarden[i] = 0;
