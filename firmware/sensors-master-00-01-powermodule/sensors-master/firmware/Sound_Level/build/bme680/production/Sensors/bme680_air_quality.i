...
# 2 "<built-in>" 2
# 1 "Sensors/bme680_air_quality.c" 2
...
# 1 "Sensors/bme680_air_quality.h" 1
# 11 "Sensors/bme680_air_quality.h"
...
# 11 "Sensors/bme680_air_quality.h" 2
...
# 12 "Sensors/bme680_air_quality.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 13 "Sensors/bme680_air_quality.h" 2

# 1 "Sensors/../global.h" 1
# 62 "Sensors/../global.h"
...
# 14 "Sensors/bme680_air_quality.h" 2
...
# 8 "Sensors/bme680_air_quality.c" 2
...
# 9 "Sensors/bme680_air_quality.c" 2


# 1 "Sensors/../mcc_generated_files/spi2.h" 1
# 117 "Sensors/../mcc_generated_files/spi2.h"
void SPI2_Initialize(void);
# 152 "Sensors/../mcc_generated_files/spi2.h"
uint8_t SPI2_Exchange8bit(uint8_t data);
# 192 "Sensors/../mcc_generated_files/spi2.h"
uint8_t SPI2_Exchange8bitBuffer(uint8_t *dataIn, uint8_t bufLen, uint8_t *dataOut);
# 215 "Sensors/../mcc_generated_files/spi2.h"
_Bool SPI2_IsBufferFull(void);
# 240 "Sensors/../mcc_generated_files/spi2.h"
_Bool SPI2_HasWriteCollisionOccured(void);
# 264 "Sensors/../mcc_generated_files/spi2.h"
void SPI2_ClearWriteCollisionStatus(void);
# 11 "Sensors/bme680_air_quality.c" 2
...
uint8_t measurementData[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
int8_t spi_read(uint8_t dev_id, uint8_t reg_addr, uint8_t *reg_data, uint16_t len){
    ...
    while(len--){
        *reg_data = SPI2_Exchange8bit(0x0);
        reg_data++;
    }
...
void BME680_Init(void){
    ...
    gas_sensor.tph_sett.os_temp = 4;
    gas_sensor.tph_sett.os_hum = 2;
    gas_sensor.tph_sett.os_pres = 3;

    gas_sensor.tph_sett.filter = 2;


    gas_sensor.gas_sett.run_gas = 0x01;
    ...
    gas_sensor.power_mode = 1;


    set_required_settings = 1 | 2 | 4 | 16
        | (8 | 64 | 128);
...
void BME680_Measure(void){
    ...
    while(!(dataBME.status & 0x80)){

      do { LATAbits.LATA2 = 1; } while(0);
      ;
    }

    uint16_t dataTemperature = 0x0000;
    ...
    measurementData[0] = dataTemperature & 0xFF;
    measurementData[1] = (dataTemperature >> 8);
    measurementData[2] = (dataPressure+50)/100 & 0xFF;
    measurementData[3] = ((dataPressure+50)/100 >> 8) & 0xFF;
    measurementData[4] = (dataHumidity+5)/10 & 0xFF;
    measurementData[5] = ((dataHumidity+5)/10 >> 8) & 0xFF;


    measurementData[6] = IAQ & 0xFF;
    measurementData[7] = (IAQ >> 8);
...
void BME680_SetThreshold(uint8_t metric, uint8_t * thresholds){
