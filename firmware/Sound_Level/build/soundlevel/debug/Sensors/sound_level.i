...
# 108 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic16f18446.h"
...
if(STATUSbits.nTO == 0){
WDTCON0bits.SWDTEN = 1;
if(!measurementRunning && thresholdEnabled) startMeasurement = 1;
}
asm("clrwdt");
