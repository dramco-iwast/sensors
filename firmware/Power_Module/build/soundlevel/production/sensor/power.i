...
volatile uint8_t measurementData[2* 0x02];
...
measurementData[1] = 0x02;

measurementData[2] = 0x03;
measurementData[3] = 0x04;
...
floatBatThresholdLevelHigh = (float) batThresholdLevelHigh / 10000;
}
if(metric == 1)
{
...
if(batThresholdEnabled || ldrThresholdEnabled)
{
WDTCON0bits.SEN = 0;
asm("clrwdt");
WDTCON0bits.SEN = 1;
